...
/**
 * Port.java Class port- the one which represents a port on any module. Created
 * on December 7, 2006
 * 
 * @author Rohit
 */
public class Port {
    ...
    /**
     * Returns the packet without destroying it. This is required by WireUI to
     * draw data packets in GUI.
     * 
     * @return
     */
