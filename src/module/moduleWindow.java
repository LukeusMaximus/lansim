...
/**
 * This creates a window for the modules to display messages. It also
 * autoscrolls the JTexAreas. Each JTexArea's autoscrolling can be set
 * independently.
 * 
 * @author Rohit
 * @author Nirupam
...
public class moduleWindow implements ActionListener {
    ...
    public moduleWindow(ModuleWinUI mod) {
        ...
        if (jFrame == null) {
            ...
            jFrame.setIconImage(new ImageIcon(Config.iconPath + "module.png")
                    .getImage());
        }
    }
    ...
    private JTabbedPane getClientArea() {
        if (ClientArea == null) {
            ...
            if (propPg != null) {
                ...
                noPropPg.add(new JLabel(
                        "Property Page is not available in this mode."),
                        BorderLayout.CENTER);
                ...
                ClientArea.addTab("Property", new JScrollPane(prop));// Sets
                                                                     // property
                                                                     // window.
            }
