...
class MainWindow {
    ...
    JButton cmdComponents[] = null; // This will contain all the components'
                                    // buttons.
    String ComponentsName[] = null; // Both this and cmdComponents are
                                    // initialized in ApplicationManager.
    String ComponentModulePath[] = null; // Path to Component modules. Set my
                                         // ApplicationManager.
    ...
    private JFrame getJFrame() {
        if (jFrame == null) {
            ...
            jFrame.setIconImage(new ImageIcon(Config.iconPath + "lansim.png")
                    .getImage());
        }
        return jFrame;
    }
    ...
    private JButton getCmdComponents(int i) {
        if (cmdComponents[i] == null) {
            ...
            Image icon = new ImageIcon(Config.moduleDirPath + "/"
                    + ComponentsName[i] + "/icon.gif").getImage()
     ...
     */
    /*
     * private JTabbedPane getClientArea() { if (ClientArea == null) {
     ...
     * ClientArea.addMouseListener(ApplicationManager.application); } return
     * ClientArea; }
     */
    ...
    /**
     * Called to create a new client space where the contents of another file
     * can be shown or created. This allows for opening and creation of multiple
     * files.
     * 
     */
     ...
     */
    /*
     * public void removeClientSpace(ManagerUI clientspc){
     * ClientArea.remove(clientspc); clientSpace.remove(clientspc); }
     */
     ...
     */
    /*
     * public void removeClientSpace(int index){ ClientArea.remove(index);
     * clientSpace.remove(index); }
     */
